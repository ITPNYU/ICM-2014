...
Using arrays, write a program that creates multiple instances of an object (feel free to use an object you developed previously or create something new).  [Here is an example you can use as a model](https://github.com/ITPNYU/ICM-2014/tree/master/exercises-inclass/week6-arrays/particle_arrays).  You should probably stop here, but here are some additional (more difficult) possibilities.
        ...
        - Create an object that stores the history of its own path.  This might be a drawing program where you keep a history of mouse locations in an ArrayList or a shape that moves around the screen autonomously and draws its own trail.  Can you have an ArrayList of these objects (each of which tracks its own ArrayList?). [Example 1](https://github.com/ITPNYU/ICM-2014/tree/master/exercises-inclass/week6-arrays/history) [Example 2](https://github.com/ITPNYU/ICM-2014/tree/master/exercises-inclass/week6-arrays/history)
